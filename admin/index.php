...
<h2>الاخبار</h2>
<label for="inputname" class="form-label">عنوان الخبر</label>
<input type="text" class="form-control">
<div class="form-text">
  يجب أن يحتوي على نص.
</div>
<label for="inputname" class="form-label">وصف الخبر</label>
<input type="text" class="form-control">
<div class="form-text">
  يجب أن يحتوي على نص.
</div>
<label for="inputname" class="form-label">رابط الخبر</label>
<input type="text" class="form-control">
<div class="form-text">
  يجب أن يحتوي على نص.
</div>
